...
module.exports = options => {
  ...
  if (!entry) {
    console.warn(
      '你没有提供应用的入口文件，默认指向[moduleScope]下的index.js文件'
    );
    entry = './index.js';
  }
  ...
  var config = {
    ...
    //是否启用commonChunk
    useCommonChunk:
      options.useCommonChunk === undefined ? true : options.useCommonChunk,
